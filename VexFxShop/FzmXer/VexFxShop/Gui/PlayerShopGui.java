...
public class PlayerShopGui extends VexGui {
	...
	public PlayerShopGui(Main main, Player player) {
		/* 设置背景图片 */
		super(Main.syshopg.get(1).getBg_image(), Main.syshopg.get(1).getBg_x(),
		...
		vc.add(new VexButton(0, "", Main.syshopg.get(1).getExit_image1(),
				Main.syshopg.get(1).getExit_image2(), Main.syshopg.get(1).getExit_x(),
		...
		vc.add(new VexImage(Main.syshopg.get(1).getInfo_money_image(),
		...
		if (Main.isPoint) {
			vc.add(new VexImage(Main.syshopg.get(1).getInfo_point_image(),
		...
		/* 如果是OP，添加上架按钮 */
		if (player.isOp() || player.hasPermission("fzmxer.admin.vexfxshop.sell")) {
			/* 上架按钮 */
			vc.add(new VexButton(1, Main.syshopg.get(1).getUpitem_text(),
					Main.syshopg.get(1).getUpitem_image1(),
					Main.syshopg.get(1).getUpitem_image2(), Main.syshopg.get(1).getUpitem_x(),
		...
		if (Main.playerlist != null) {
			...
			VexScrollingList vsl = new VexScrollingList(Main.syshopg.get(1).getList_list_x(),
					...
					Main.syshopg.get(1).getList_list_h(),
					Main.syshopg.get(1).getList_list_h()
							+ ((Main.playerlist.size() - 4) * Main.syshopg.get(1).getList_itembg_h()
									+ Main.syshopg.get(1).getList_list_b()));
//			int size;
			int y = 0;
			for (ItemInfo info : Main.playerlist) {
				/* 商品背景图 */
				vsl.addComponent(new VexImage(Main.syshopg.get(1).getList_itembg_image(),
						Main.syshopg.get(1).getList_itembg_x(),
						Main.syshopg.get(1).getList_itembg_y() * y + Main.syshopg.get(0).getList_itembg_b(),
...
//								26 * y + Main.syshopg.get(0).getList_item_b(), size, size));
				...
				if (Main.isPoint) {
					vsl.addComponent(new VexText(Main.syshopg.get(1).getList_itemdj_point_x(),
							Main.syshopg.get(1).getList_itemdj_point_y() * y
									+ Main.syshopg.get(1).getList_itemdj_point_b(),
				...
				VexButton buy = new VexButton(y + 2, Main.syshopg.get(1).getList_itembuy_text() + "§f",
						Main.syshopg.get(1).getList_itembuy_image1(),
						Main.syshopg.get(1).getList_itembuy_image2(),
